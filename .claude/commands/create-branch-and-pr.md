---
allowed-tools: Bash(gh pr create *), Bash(git status *), Bash(git diff *), Bash(git switch *), Bash(git add *), Bash(git commit *), Bash(git push *), Bash(git rev-parse *), Bash(git branch *), Bash(git log *)
